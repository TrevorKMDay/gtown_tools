...
% When we pass thr1=1, it comes in the format '1:t', where t is the t threshold
% If it's boostrapped, it comes as '-5' and this has no effect except to assign
% thr1=-5
thresh = strsplit(thr1, ":") ;
length(thresh)
